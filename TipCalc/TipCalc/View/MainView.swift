...
extension MainController {
    ...
    private func outputValues() {
        ...
        let splitPeopleValueStackView = UIStackView(arrangedSubviews: [peopleSplitValueLabel, splitValueLabel])
        splitPeopleValueStackView.axis = .horizontal
        
        let splitStackView = UIStackView(arrangedSubviews: [splitLabel, UIView(), splitStepper])
        splitStackView.axis = .horizontal
        
        let stackView = UIStackView(arrangedSubviews:
            [tipStackView, totalpStackView, splitPeopleValueStackView, splitStackView]
        )
        ...
        stackView.anchor(top: bottomView.bottomAnchor, left: bottomView.leftAnchor, bottom: nil, right: bottomView.rightAnchor, padding: .init(top: 0, left: 0, bottom: 0, right: 0), size: .init(width: 0, height: 200))
